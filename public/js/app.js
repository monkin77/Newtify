...
function addEventListeners() {
    ...
    if (articleFilter) articleFilter.addEventListener("change", filterArticles);
...
setSearchType = (item) => {
    ...
    select("#searchForm input[name='type']").value =
...
tinymce.init({
    selector: "#body",
    plugins: "autosave autolink lists media table",
    toolbar: "numlist bullist code table",
