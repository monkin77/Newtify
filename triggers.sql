...
INSERT INTO "authenticated_user"(name, birth_date, password, is_suspended, reputation) VALUES ('bruno', CURRENT_TIMESTAMP, '1234567', false, 10);
INSERT INTO "authenticated_user"(name, birth_date, password, is_suspended, reputation) VALUES ('rui', CURRENT_TIMESTAMP, '1234567', false, 10);
INSERT INTO "authenticated_user"(name, birth_date, password, is_suspended, reputation) VALUES ('joao', CURRENT_TIMESTAMP, '1234567', true, 10);

INSERT INTO "suspension" (reason,start_time,end_time,admin_id,user_id)
VALUES ('AAAAAAAAAAAAAAA',TO_TIMESTAMP('2019-04-23', 'YYYY-MM-DD'),TO_TIMESTAMP('2021-07-13', 'YYYY-MM-DD'),1,2);

INSERT INTO "suspension" (reason,start_time,end_time,admin_id,user_id)
VALUES ('AAAAAAAAAAAAAAA',TO_TIMESTAMP('2019-04-23', 'YYYY-MM-DD'),TO_TIMESTAMP('2021-07-13', 'YYYY-MM-DD'),1,3);